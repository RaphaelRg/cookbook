...
<body>
	...
	<h1 style="margin-top:1em">Rezeptsuche</h1>
	...
	<?php
		if (isset($_POST['Suche'])){
			...
			$results = retrive_rezepte($_POST["titel"], $_POST["jahr"], $_POST["heft"], $_POST["gang"], $_POST["hauptzutat"], $_POST["schlagwort"]);
